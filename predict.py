...
from metrics.utils import load_model,load_img, find_files, rm_n_mkdir
...
def predict_batch(model, dataset_name):
    ...
    """
    model_name = 'dist'
    img_dir = "/root/autodl-tmp/archive/datasets/{}/patched/coco_format/images/test".format(dataset_name)
    file_list = find_files(img_dir, ext='jpg')
    save_dir = "/root/autodl-tmp/archive/datasets/{}/patched/infer/{}".format(dataset_name, model_name)
    rm_n_mkdir(save_dir)
